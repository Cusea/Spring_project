	...
	<div class="row mb-3">
		...
		<div class="col-sm-3 row justify-content-end sc_btn">
			<div class="col-8 list-group text-center " id="list-tab">
				...
				<a class="list-group-item list-group-item-action active" id="list-terms-list"  href='${contextpath}/ServiceCenter/terms' aria-controls="">
					이용약관
				</a>
			...
			<div class="tab-content" id="nav-tabContent">
				...
				<div class="tab-pane fade show active" id="list-terms" role="tabpanel" aria-labelledby="list-terms-list">
					...
					<div class="my-3">
						...
						<div>이 서비스 이용약관(이하 “약관”이라 합니다)은 우리가 제공하는 서비스와 관련하여 회사와 이용 고객(또는 회원) 간에 서비스의 이용 조건 및 절차, 회사와 회원 간의 권리, 의무 및 책임 사항 기타 필요한 사항을 규정함을 목적으로 합니다.</div>
						...
						3. ID(고유번호) : 회원의 식별과 회원의 서비스 이용을 위하여 회원이 선정하고 회사가 승인하는 이메일을 말합니다.<br>
