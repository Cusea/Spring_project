...
insert into ANSWER (NUM, USERS_NUM, QUESTION_NUM, TAG_NAME, TEXT, INDATE)
values (1, 1, 1, '오사카', '오사카 여기 좋아요!!!', sysdate);
insert into ANSWER (NUM, USERS_NUM, QUESTION_NUM, TAG_NAME, TEXT, INDATE)
values (2, 2, 2, '후쿠오카', '후쿠오카 여기 좋아요!!!', sysdate);
insert into ANSWER (NUM, USERS_NUM, QUESTION_NUM, TAG_NAME, TEXT, INDATE)
values (3, 3, 3, '오사카 맛집', '오사카 이치란 라멘집 여기 좋아요!!!', sysdate);
insert into ANSWER (NUM, USERS_NUM, QUESTION_NUM, TAG_NAME, TEXT, INDATE)
values (4, 3, 3, '오사카 맛집', '오사카 장어덮밥 여기 맛나요!!!', sysdate);
